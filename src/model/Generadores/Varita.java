...
public class Varita extends Generador {

    private final String[] NOMBRES = {"Varita de madera", "Varita de plástico", "Varita esmeralda", "Varita de fuego", "Varita de sauco"};
    private int dineroBase = 50;
